...
- [5. General](#5-general)
  ...
  - [5.14. Q: Are there are projects built around MeshCore?](#514-q-are-there-are-projects-built-around-meshcore)
    ...
    - [5.14.6. pyMC_core](#5146-pymc_core)
- [6. Troubleshooting](#6-troubleshooting)
  ...
  - [6.7. Q: My RAK/T1000-E/xiao_nRF52 device seems to be corrupted, how do I wipe it clean to start fresh?](#67-q-my-rakt1000-exiao_nrf52-device-seems-to-be-corrupted-how-do-i-wipe-it-clean-to-start-fresh)
...
_How to build and flash Meshcore repeater firmware | Heltec V3_
<https://www.youtube.com/watch?v=WJvg6dt13hk> _(Link referenced in the Discord post)_
...
To start managing your USB serial-connected device using picocom, use the following command: - `picocom -b 115200 /dev/ttyUSB0 --imap lfcrlf`

From here, reference repeater and room server command line commands on MeshCore github wiki here: - https://github.com/meshcore-dev/MeshCore/wiki/Repeater-&-Room-Server-CLI-Reference
...
12. If it fails, try turning off and on Bluetooth on your phone. If that doesn't work, try rebooting your phone.
